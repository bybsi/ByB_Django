function loginAction(e, formId) {
        e.preventDefault(); 
        fetchData("/actions/login.php", $("#"+formId).serialize(), {dataType:'html'})
...
$(function(){
    ...
    $("#register_button").on("click", function(evt){
        loadDialog({dialogId:"_byb_dialog", url:"/forms/register.php", evt:evt, position:{my:'right top',at:'bottom left',of:evt}, title:'Register',buttons:{
            "Register": {
                text:"Register",
